...
export const INVITE_WRONG_HEADING = "Wrong account";
export const INVITE_WRONG_BODY_PRE = "This invite was sent to";
export const INVITE_WRONG_BODY_POST =
  "Please switch to that account to accept.";
export const INVITE_WRONG_CTA = "Switch account";
